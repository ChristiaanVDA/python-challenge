...
user_input = input("Which employee data file would you like to open? 1 or 2 ? " )
...
if user_input=="1":
    ...
    print("You have chosen employee_data1")
elif user_input=="2":
    file_choice = csvpath2
    print("You have chosen employee_data2")
else:
    file_choice = csvpath2
    print("You have not made a valid choice. Opening employee_data2")
